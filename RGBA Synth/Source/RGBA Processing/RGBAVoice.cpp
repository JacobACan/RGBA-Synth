	...
	if (angleDelta != 0)
	{
		if (realeaseLevel > 0.0)
		{
			for (int sample = startSample; sample < numSamples; sample++)
			{
				...
				leftChannel[sample] += sinWavNoteSample * level * attackLevel * realeaseLevel * .5;
				rightChannel[sample] += sinWavNoteSample * level * attackLevel * realeaseLevel * .5;
		...
		else
		{
			for (int sample = startSample; sample < numSamples; sample++)
			{
				...
				leftChannel[sample] += sinWavNoteSample * level * attackLevel * .5;
				rightChannel[sample] += sinWavNoteSample * level * attackLevel * .5;
	...
	if (angleDelta != 0)
	{
		if (realeaseLevel > 0.0)
		{
			for (int sample = startSample; sample < numSamples; sample++)
			{
				...
				leftChannel[sample] += sinWavNoteSample * level * attackLevel * realeaseLevel * juce::Decibels::decibelsToGain(-18);
				rightChannel[sample] += sinWavNoteSample * level * attackLevel * realeaseLevel * juce::Decibels::decibelsToGain(-18);
		...
		else
		{
			for (int sample = startSample; sample < numSamples; sample++)
			{
				...
				leftChannel[sample] += sinWavNoteSample * level * attackLevel * juce::Decibels::decibelsToGain(-18);
				rightChannel[sample] += sinWavNoteSample * level * attackLevel * juce::Decibels::decibelsToGain(-18);
